...
class MainWindow(QMainWindow):
    ...
    def setup_page1(self, page):
        ...
        font = QFont("Arial", 24, QFont.Normal)  # Using QFont.Normal for regular weight
        text_label.setFont(font)
        text_label.setStyleSheet("text-align: left;color: #474B4F; background: transparent; font: normal normal 600 28px/42px Arial;opacity: 1;")  # Adjust font size as needed
        ...
        font = QFont("Arial", 12, QFont.Normal)  # Using QFont.Normal for regular weight
        lorem_label1.setFont(font)
        lorem_label1.setStyleSheet("text-align: left;color: #474B4F; background: transparent; font:normal normal normal 12px/22px Arial;opacity: 1;")  # Adjust font size as needed
        ...
        lorem_label2.setFont(QFont("Arial", 12, QFont.Normal))
    ...
    def setup_page2(self, page):
        ...
        text_label.setGeometry(50, 211, 380, 39)
        text_label.setAlignment(Qt.AlignLeft | Qt.AlignVCenter)  # Align left and vertically centered
        font = QFont("Arial", 24, QFont.Weight(600))  # Adjust the font size if needed
        text_label.setFont(font)
        text_label.setStyleSheet("color: #474B4F; background: transparent; font: normal normal 600 28px/42px Arial;opacity: 1;")
        text_label.setWordWrap(False)  # Disable word wrap
        text_label.show()
        ...
        lorem_label1.setGeometry(50, 280, 332, 61)
        lorem_label1.setAlignment(Qt.AlignLeft | Qt.AlignTop)  # Align left and top
        lorem_label1.setFont(QFont("Arial", 12, QFont.Normal))
        lorem_label1.setStyleSheet("color: #474B4F; background: transparent;font: normal normal normal 12px/22px Arial;opacity: 1;")
        lorem_label1.setWordWrap(True)  # Enable word wrap
        lorem_label1.show()
        ...
        lorem_label2.setAlignment(Qt.AlignLeft | Qt.AlignTop)  # Align left and top
        lorem_label2.setFont(QFont("Arial", 12, QFont.Normal))
        lorem_label2.setStyleSheet("color: #474B4F; background: transparent;font: normal normal normal 12px/22px Arial;opacity: 1;")
        lorem_label2.setWordWrap(True)  # Enable word wrap
        lorem_label2.show()
    ...
    def setup_page3(self, page):
        ...
        lorem_label1.setAlignment(Qt.AlignLeft | Qt.AlignTop)  # Align left and top
        lorem_label1.setFont(QFont("Arial", 12, QFont.Normal))  # Font with specified properties
        ...
        for i, browser in enumerate(browsers):
            ...
            browser_label.setAlignment(Qt.AlignLeft | Qt.AlignVCenter)  
            browser_label.setFont(QFont("Arial", 12, QFont.Normal)) 
